class LinearModel(object):
    ...
    def __init__(self, step_size=0.2, max_iter=100, eps=1e-5,
        ...
        """
        Args:
            step_size: Step size for iterative solvers only, i.e. alpha
    ...
    def fit(self, x, y):
        ...
        Args:
            x: Training example inputs in numpy array. Shape (m, n).
            y: Training example labels in numpy array. Shape (m,).   
        """
